    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="landing">
      ...
      >
        ...
        <p className="landing__featured-description">
          From begginer to advanced. in all industries, we have the right courses just for you and preparing your entire journey for
          learning and making the most
        </p>

        <div className="landing__tags">
          {["web development", "enterprise IT", "react", "nextjs"].map((tag, index) => {
            return (
